...
public class CommentHeartService {
    ...
    public void create(Long commentId, AccountInfoRequestDto requestDto) {
        ...
        if (isExistsByWriterAndComment(account, comment)) throw new RuntimeException("이미 좋아요를 눌렀습니다.");
    ...
    private boolean isExistsByWriterAndComment(Account account, Comment comment) {
